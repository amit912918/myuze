        ...
        <div className='mt-12 w-[400px]'>
            <nav className="fixed bottom-0 inset-x-0 bg-white border-t w-[400px] m-auto mt-4 shadow-md rounded-t-3xl px-6 py-2 z-50">
                <div className="flex justify-between items-center">
                    <div className="flex flex-col items-center text-gray-500 text-xs font-medium text-black">
                    ...
                    <div onClick={() => handleMenuBar('category')} className="flex flex-col items-center text-gray-500 text-xs cursor-pointer">
                    ...
                    <div onClick={() => handleMenuBar('profile')} className="flex flex-col items-center text-gray-500 text-xs cursor-pointer">
